...
const FullTimeOpenings = () => {
  return (
    ...
    <section id='full-time-section' className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-100 pt-20">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {internshipsData.map((internship) => (
          <OpportunityCard
            ...
            stipend="Unpaid"               // or dynamic value if you have one
            logo={internship.logoSrc}      // maps correctly to OpportunityCard prop
            type="Internship"              // static for now, or make dynamic
            location="Remote"              // or add a location field to data
            postedDate={internship.openingDate}
            closingDate={internship.closingDate}
            postedOn="LinkedIn"            // or whichever source/platform
          />
