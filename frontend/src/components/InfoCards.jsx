...
const InfoCards = ({ title, company, duration, imageText, closingDate, logoSrc }) => {
  ...
  return (
    <div className="bg-gray-100 border border-gray-500 rounded-2xl shadow-md overflow-hidden border border-gray-200 transition transform hover:scale-[1.02] duration-300">
